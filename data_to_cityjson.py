################################################################################
# Code for converting the generated NumPy arrays to CityJSON objects.
################################################################################
...
years = [2010, 2015, 2020, 2025, 2030, 2035, 2040, 2045, 2050, 2055, 2060] # choose years

vertices = 30 # choose number of vertices for cylinder, must be even number of at least 8

model = 'treedict' # choose method

area = 'test_area' # choose area
...
for n, y in enumerate(years):
    ...
    to_cityJSON(radius_T[1], groundlevel_list, groundwater_list, x_list, y_list, number_list, vertices, 'reasonable', area, model, y)
    to_cityJSON(radius_T[2], groundlevel_list, groundwater_list, x_list, y_list, number_list, vertices, 'marginal', area, model, y)
